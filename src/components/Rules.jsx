...
const Rules = ({ handleClose }) => {
  ...
  return (
    <div className="z-20 transition-all opacity-100">
      <div
        onClick={() => handleClose()}
        className={`transition-all ease-in-out min-w-[800px] duration-1000 w-[100vw] z-30 h-[110vh] absolute left-0 top-0 opacity-${opacity}  bg-black`}
      ></div>
